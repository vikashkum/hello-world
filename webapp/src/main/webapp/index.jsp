...
<div class="text text-1">K</div><div class="text text-2">e</div><div class="text text-3">r</div><div class="text text-4">i</div><div class="text text-2">x</div><div class="text text-1">a</div><a target="_blank" href="https://www.htmlbestcodes.com/" style="font-size: 8pt; text-decoration: none;font-family:Tahoma">HTML Best Codes</a>
